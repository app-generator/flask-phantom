# -*- encoding: utf-8 -*-
"""
Flask Phantom - HTML5 Up Phantom design coded in Flask
...
def elements():
    ...
    # custommize your page title / description here
    page_title       = 'Elements - PhantomFlask coded in Flask | AppSeed App Generator'
    page_description = 'HTML5 Up Phantom design coded in Flask Microframework, elements page.'
...
def about():
    ...
    # custommize your page title / description here
    page_title       = 'About - PhantomFlask coded in Flask | AppSeed App Generator'
    page_description = 'HTML5 Up Phantom design coded in Flask Microframework, about page.'
...
def index(path):
    ...
    page_title       = 'Phantom - HTML5 Up design coded in Flask | AppSeed App Generator'
    page_description = 'App designed by HTML5 Up and coded in Flask Microframework with SQLite database, ORM and authentication'
